 ...
 * 
 */
@WebServiceClient(name = "HelloServiceImplService", targetNamespace = "http://webservice.servermerchant.com/", wsdlLocation = "http://servermerchant.herokuapp.com/HelloService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICEIMPLSERVICE_QNAME = new QName("http://webservice.servermerchant.com/", "HelloServiceImplService");
    ...
    public HelloService getHelloServiceImplPort() {
        return super.getPort(new QName("http://webservice.servermerchant.com/", "HelloServiceImplPort"), HelloService.class);
    }
    ...
    public HelloService getHelloServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice.servermerchant.com/", "HelloServiceImplPort"), HelloService.class, features);
    }
