 ...
 * 
 */
@WebServiceClient(name = "HelloServiceImplService", targetNamespace = "http://webservice.serversismic.com/", wsdlLocation = "http://serversismic.herokuapp.com/HelloService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICEIMPLSERVICE_QNAME = new QName("http://webservice.serversismic.com/", "HelloServiceImplService");
    ...
    public HelloService getHelloServiceImplPort() {
        return super.getPort(new QName("http://webservice.serversismic.com/", "HelloServiceImplPort"), HelloService.class);
    }
    ...
    public HelloService getHelloServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice.serversismic.com/", "HelloServiceImplPort"), HelloService.class, features);
    }
