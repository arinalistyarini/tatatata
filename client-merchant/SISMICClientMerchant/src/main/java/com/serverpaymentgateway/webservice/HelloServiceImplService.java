 ...
 * 
 */
@WebServiceClient(name = "HelloServiceImplService", targetNamespace = "http://webservice.serverpaymentgateway.com/", wsdlLocation = "http://serverpaymentgateway.herokuapp.com/HelloService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICEIMPLSERVICE_QNAME = new QName("http://webservice.serverpaymentgateway.com/", "HelloServiceImplService");
    ...
    public HelloService getHelloServiceImplPort() {
        return super.getPort(new QName("http://webservice.serverpaymentgateway.com/", "HelloServiceImplPort"), HelloService.class);
    }
    ...
    public HelloService getHelloServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice.serverpaymentgateway.com/", "HelloServiceImplPort"), HelloService.class, features);
    }
