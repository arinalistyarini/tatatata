 ...
 * 
 */
@WebServiceClient(name = "HelloServiceImplService", targetNamespace = "http://servicemerchant.heroku.chamerling.org/", wsdlLocation = "http://servermerchant.herokuapp.com/HelloService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICEIMPLSERVICE_QNAME = new QName("http://servicemerchant.heroku.chamerling.org/", "HelloServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://servermerchant.herokuapp.com/HelloService?wsdl");
    ...
    public HelloService getHelloServiceImplPort() {
        return super.getPort(new QName("http://servicemerchant.heroku.chamerling.org/", "HelloServiceImplPort"), HelloService.class);
    }
    ...
    public HelloService getHelloServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://servicemerchant.heroku.chamerling.org/", "HelloServiceImplPort"), HelloService.class, features);
    }
