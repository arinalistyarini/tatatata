 ...
 * 
 */
@WebServiceClient(name = "HelloServiceImplService", targetNamespace = "http://servicesismic.heroku.chamerling.org/", wsdlLocation = "http://serversismic.herokuapp.com/HelloService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICEIMPLSERVICE_QNAME = new QName("http://servicesismic.heroku.chamerling.org/", "HelloServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://serversismic.herokuapp.com/HelloService?wsdl");
    ...
    public HelloService getHelloServiceImplPort() {
        return super.getPort(new QName("http://servicesismic.heroku.chamerling.org/", "HelloServiceImplPort"), HelloService.class);
    }
    ...
    public HelloService getHelloServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://servicesismic.heroku.chamerling.org/", "HelloServiceImplPort"), HelloService.class, features);
    }
